...
var words = ['주민등록번호, 여권번호, 운전면허번호, 외국인등록번호, 외국인등록정보, 신분증 사본', '인종, 민족, 종교, 노동조합, 유전, 정당, 정치, 사상, 성생활', '지문, 얼굴, 홍채, 망막, 정맥, 귓바퀴',
			...
			'MAC 주소',	'사이트 방문 기록, 방문 일시, 서비스 방문 기록, 서비스 이용기록', '접속 기록, 로그, 접속 로그', '쿠키, cookie', '기기정보, 단말기기정보, 단말기 정보, 단말기에 관한 정보', 
