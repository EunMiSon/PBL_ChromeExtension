...
var words = ['주민등록번호, 여권번호, 운전면허번호, 외국인등록번호', '인종, 민족, 종교, 노동조합, 유전, 정당, 정치, 성생활', '지문, 얼굴, 홍채, 망막, 정맥, 귓바퀴', '뇌파, 심전도, 유전정보',
			'음성, 필적, 걸음걸이, 자판입력', '신용정보, 신용카드번호, 계좌번호', '위치정보, 개인위치정보', '건강상태, 진료기록', '성별',
			'학력, 직업, 키, 몸무게, 결혼(혼인)여부, 결혼기념일, 자녀정보, 취미, 관심분야, 취향, 운전면허, 운전여부', 'IP 주소, IP Address', 'MAC 주소',
			'사이트 방문 기록, 서비스 방문 기록, 서비스 이용기록', '접속 기록, 로그, 접속 로그', '쿠키, cookie', '기기정보, 단말기기정보, 단말기 정보, 단말기에 관한 정보', '브라우저', 'OS, 운영체제',
			'사원증 번호, 사원 번호', '검색어, 검색기록', '위탁, 수탁', '제 3자, 제 3자에게 제공', '국외이전', '전화권유판매', '전화상담, 안내권유전화, 텔레마케팅', '마케팅, 마켓팅', '광고',
			'맞춤형 광고', '이벤트, 이벤트 참여, 이벤트 개인정보', '맞춤식 서비스, 맞춤형 서비스, 개인 특화 서비스, 맞춤 서비스', '제휴 서비스, 제휴사, 제휴회사']; //31개

var reasons = ['이 항목들은 고유식별정보에 해당합니다. 약관에 해당 항목들이 포함되어 있다면 서비스를 이용하는데 꼭 필요한 정보인지 확인할 필요가 있습니다.',
				...
				'이 항목은 개인식별정보입니다. 약관에 해당 항목이 포함되어 있다면 서비스를 이용하는데 꼭 필요한 정보인지 확인할 필요가 있습니다.',
				...
				'인터넷에 접속하여 수행한 업무 내역에 대하여 계정, 접속 일시, 접속자 정보, 수행한 업무 등이 기록되어 이를 통해 맞춤형 광고 등 이용자의 개인정보가 분석될 가능성이 높다.',
